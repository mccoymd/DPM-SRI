...
def upgrade():
    ...
    op.add_column(
        "parameters", sa.Column("drug_sensitivities_id", sa.Integer(), nullable=True)
    )
    ...
    op.create_foreign_key(
        None, "parameters", "drug_sensitivities", ["drug_sensitivities_id"], ["id"]
    )
...
def downgrade():
    ...
    op.add_column(
        "parameters",
        sa.Column(
            "drug_senstivities_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
